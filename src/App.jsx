...
const chartColors = ['#00e5ff', '#ff3d81', '#9cff6e', '#ffd166', '#b892ff', '#8bd3dd', '#ff8fab']
    ...
    <div className="app-shell" style={{ '--brand': budget.brandSettings.primaryColor, '--accent': budget.brandSettings.secondaryColor }}>
      <aside className="sidebar">
        <div className="brand-lockup">
          {budget.brandSettings.logo ? <img src={budget.brandSettings.logo} alt="BANI VFX" /> : <div className="logo-mark">B</div>}
          <div>
            <strong>BANI VFX</strong>
            <span>Budget Lab</span>
          </div>
        </div>
        <nav>
      ...
      <div className="export-page" ref={exportRef} style={{ backgroundColor: budget.brandSettings.backgroundColor }}>
        ...
        {opts.cover && (
          <div className="export-cover">
            <div className="export-logo">{budget.brandSettings.logo ? <img src={budget.brandSettings.logo} alt="BANI VFX" /> : 'BANI VFX'}</div>
